...
This agent helps create new microagents in the `.omniagent/microagents` directory by providing guidance and templates.
...
- Create a markdown file in `.omniagent/microagents/` with an appropriate name (e.g., `github.md`, `google_workspace.md`)
...
- [Microagents Overview](https://docs.OmniAgent.dev/usage/prompting/microagents-overview)
- [Example GitHub Skill](https://github.com/ismailubts/OmniAgent/blob/main/skills/github.md)
