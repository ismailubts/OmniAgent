...
from omniagent.analytics import (
    AnalyticsService,
    get_analytics_service,
    init_analytics_service,
)
from omniagent.analytics.analytics_constants import (
...
from omniagent.analytics.analytics_service import AnalyticsService as DirectService
from omniagent.analytics.oss_install_id import get_or_create_install_id
from omniagent.server.types import AppMode
...
def reset_singleton():
    ...
    import omniagent.analytics as analytics_module
...
def mock_posthog():
    ...
    with patch(
        'omniagent.analytics.analytics_service.Posthog', autospec=True
    ) as MockClass:
