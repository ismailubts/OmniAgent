...
from omniagent.analytics.user_provider import (
...
def _patch_user_provider(provider: AnalyticsUserProvider):
    ...
    return patch(
        'omniagent.analytics.analytics_context._get_user_provider',
...
class TestResolveContext:
    ...
    async def test_resolve_analytics_context_logs_warning_on_failure(self):
        ...
        with (
            ...
            patch('omniagent.analytics.analytics_context.logger') as mock_logger,
        ):
