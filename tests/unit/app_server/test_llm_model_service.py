...
from omniagent.app_server.config_api.config_models import (
    LLMModelPage,
    ProviderPage,
)
...
from omniagent.app_server.config_api.llm_model_service import LLMModelService
...
class TestToLLMModelsHiddenCanonical:
    ...
    def test_canonical_set_only_on_mapped_hidden_models(self):
        response = ModelsResponse(
            models=['omniagent/real-model'],
            verified_models=['real-model'],
            verified_providers=['openhands'],
            default_model='omniagent/real-model',
            hidden_models=['omniagent/legacy-alias', 'omniagent/untagged-alias'],
            hidden_model_canonicals={'omniagent/legacy-alias': 'omniagent/real-model'},
        )
