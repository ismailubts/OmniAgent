...
class TestDockerSandboxService:
    ...
    @patch('omniagent.app_server.sandbox.docker_sandbox_service.base62.encodebytes')
    @patch('os.urandom')
    ...
    @patch(
        'omniagent.app_server.utils.docker_utils.is_running_in_docker',
        return_value=True,
    )
...
class TestDockerSandboxServiceInjectorFromEnv:
    ...
    def test_config_from_env_with_sandbox_host_port(self):
        ...
        with patch.dict(os.environ, env_vars, clear=False):
            ...
            import omniagent.app_server.config as config_module
            from omniagent.app_server.config import config_from_env
...
class TestDockerSandboxServiceHostNetwork:
    ...
    @patch('omniagent.app_server.sandbox.docker_sandbox_service._logger')
    @patch('omniagent.app_server.sandbox.docker_sandbox_service.base62.encodebytes')
    @patch('os.urandom')
    ...
    @patch('omniagent.app_server.sandbox.docker_sandbox_service.utc_now')
