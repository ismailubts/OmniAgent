...
from omniagent.app_server.sandbox.preset_sandbox_spec_service import (
...
class TestDockerSandboxSpecServiceInjector:
    ...
    @patch('omniagent.app_server.sandbox.docker_sandbox_spec_service.get_docker_client')
    ...
    @patch(
        'omniagent.app_server.sandbox.docker_sandbox_spec_service._global_docker_client',
        None,
    )
    ...
    def test_get_docker_client_reuses_existing_client(
        ...
        import omniagent.app_server.sandbox.docker_sandbox_spec_service as module
    ...
    @patch('omniagent.app_server.sandbox.docker_sandbox_spec_service.get_docker_client')
    @patch('omniagent.app_server.sandbox.docker_sandbox_spec_service._logger')
