...
from omniagent.app_server.services.db_session_injector import (  # noqa: E402
    DbSessionInjector,
)
from omniagent.db.ssl import (  # noqa: E402
...
class TestDbSessionInjectorConnections:
    ...
    def test_sqlite_connection_fallback(self, basic_db_session_injector):
        ...
        expected_url = (
            f'sqlite:///{basic_db_session_injector.persistence_dir}/omniagent.db'
        )
    ...
    async def test_sqlite_async_connection_fallback(self, basic_db_session_injector):
        ...
        expected_url = f'sqlite+aiosqlite:///{basic_db_session_injector.persistence_dir}/omniagent.db'
        assert str(engine.url) == expected_url

    def test_postgres_connection_with_host(self, postgres_db_session_injector):
        """Test PostgreSQL connection when host is defined."""
        with patch(
            'omniagent.app_server.services.db_session_injector.create_engine'
    ...
    async def test_postgres_async_connection_with_host(
        ...
        with patch(
            'omniagent.app_server.services.db_session_injector.create_async_engine'
    ...
    @patch(
        'omniagent.app_server.services.db_session_injector.DbSessionInjector._create_gcp_engine'
    )
    ...
    @patch(
        'omniagent.app_server.services.db_session_injector.DbSessionInjector._create_async_gcp_engine'
    )
    @pytest.mark.asyncio
...
class TestDbSessionInjectorSessionManagement:
    ...
    async def test_depends_cleanup_on_completion(self, basic_db_session_injector):
        ...
        with patch(
            'omniagent.app_server.services.db_session_injector.async_sessionmaker'
