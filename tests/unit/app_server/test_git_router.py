...
from omniagent.app_server.git.git_models import SortOrder
from omniagent.app_server.git.git_router import (
    router,
    search_branches,
    search_repositories,
...
from omniagent.app_server.utils.paging_utils import encode_page_id, paginate_results
...
class TestInstallationsEndpoint:
    ...
    def test_returns_403_when_no_provider_tokens(self, test_client):
        ...
        with patch(
            'omniagent.app_server.user.auth_user_context.AuthUserContext.get_provider_tokens',
...
class TestSearchUserInstallations:
    ...
    @pytest.mark.asyncio
    @patch('omniagent.app_server.git.git_router.ProviderHandler')
