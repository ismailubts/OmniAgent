...
from omniagent.app_server.sandbox.dynamic_remote_sandbox_spec_service import (
...
class TestFetchSpecs:
    ...
    async def test_empty_configs_fallback_uses_bundled_default_not_env_override(
        ...
        with patch(
            'omniagent.app_server.sandbox.remote_sandbox_spec_service.get_agent_server_image',
