...
from omniagent.app_server.file_store.google_cloud import GoogleCloudFileStore
...
from omniagent.app_server.file_store.s3 import S3FileStore
...
@patch(
    'omniagent.app_server.file_store.google_cloud.storage.Client',
