...
from omniagent.app_server.app_conversation.app_conversation_router import (
    AgentServerContext,
...
class TestSwitchConversationProfile:
    ...
    async def test_returns_409_when_sandbox_paused(self):
        ...
        with patch(
            'omniagent.app_server.app_conversation.app_conversation_router.'
...
class TestFinalizeSandboxDelete:
    ...
    async def test_forwards_pinned_workspace_path(self):
        ...
        await _finalize_sandbox_delete(
            ...
            httpx_client,
            conv,
            workspace_path='/home/omniagent/workspace/' + conv.hex,
        )
