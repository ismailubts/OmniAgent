...
from omniagent.app_server.event_callback.webhook_router import on_conversation_update
from omniagent.app_server.sandbox.sandbox_models import SandboxRecord
from omniagent.app_server.user.specifiy_user_context import SpecifyUserContext
...
class TestOnConversationUpdateAutoTitle:
    ...
    async def test_registers_set_title_callback_for_new_conversation(
        ...
        with (
            patch(
                'omniagent.app_server.event_callback.webhook_router.valid_conversation',
                return_value=stub_conv,
            ),
            patch(
                'omniagent.app_server.event_callback.webhook_router.get_event_callback_service',
