...
from omniagent.app_server.event_callback.event_callback_models import (
    EventCallback,
    EventCallbackStatus,
)
...
async def test_set_title_callback_processor_fetches_title_from_conversation():
    ...
    with (
        patch(
            'omniagent.app_server.config.get_app_conversation_service',
        ...
        patch('omniagent.app_server.config.get_httpx_client', get_httpx_client),
        patch(
            'omniagent.app_server.event_callback.'
