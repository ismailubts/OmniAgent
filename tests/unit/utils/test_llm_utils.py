"""Tests for omniagent.app_server.utils.llm module."""

from omniagent.app_server.utils import llm as llm_utils
...
class TestIsOpenhandsModel:
    ...
    def test_openhands_model_returns_true(self):
        """Test that models with 'omniagent/' prefix return True."""
        assert is_openhands_model('openhands/claude-sonnet-4-5-20250929') is True
        assert is_openhands_model('omniagent/gpt-5-2025-08-07') is True
        assert is_openhands_model('omniagent/gemini-2.5-pro') is True

    def test_non_openhands_model_returns_false(self):
        """Test that models without 'omniagent/' prefix return False."""
