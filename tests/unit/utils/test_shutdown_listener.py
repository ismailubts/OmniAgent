...
from omniagent.app_server.utils import shutdown_listener
from omniagent.app_server.utils.shutdown_listener import (
...
def test_signal_handler_calls_listeners():
    ...
    with patch('omniagent.app_server.utils.shutdown_listener.signal', mock_signal):
