...
from omniagent.app_server.integrations.service_types import Comment, RequestMethod
...
def test_mro_includes_resolver_mixin_and_base_git_service():
    from omniagent.app_server.integrations.bitbucket_data_center.service.resolver import (
        BitbucketDCResolverMixin,
    )
    from omniagent.app_server.integrations.service_types import BaseGitService
