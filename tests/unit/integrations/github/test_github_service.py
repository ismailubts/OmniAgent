...
from omniagent.app_server.integrations.github.github_service import GitHubService
...
async def test_github_search_repositories_with_organizations():
        ...
        'items': [
            {
                'id': 1,
                'name': 'OmniAgent',
                'full_name': 'ismailubts/OmniAgent',
                'private': False,
                'html_url': 'https://github.com/ismailubts/OmniAgent',
                'clone_url': 'https://github.com/ismailubts/OmniAgent.git',
                'pushed_at': '2023-01-01T00:00:00Z',
                'owner': {'login': 'ismailubts', 'type': 'User'},
            }
        ]
    }
    ...
    with (
        ...
        patch.object(
            ...
            return_value=['ismailubts', 'example-org'],
        ),
        patch.object(
        ...
        assert org1_params['q'] == 'openhands org:ismailubts'
        ...
        assert all(repo.full_name == 'ismailubts/OmniAgent' for repo in repositories)
...
async def test_github_get_user_organizations():
    ...
    with patch.object(service, '_make_request', return_value=(mock_orgs_response, {})):
        ...
        assert orgs == ['ismailubts', 'example-org']
...
async def test_resolve_primary_email_selects_primary_verified():
    ...
    from omniagent.app_server.integrations.github.service.base import GitHubMixinBase
