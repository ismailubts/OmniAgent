"""Bootstrap a default OmniAgent organization for OHE installs."""
...
def get_default_org_config() -> DefaultOrgConfig:
    return DefaultOrgConfig(
        ...
        org_name=_env_value(
            'OMNIAGENT_DEFAULT_ORG_NAME',
            'OH_DEFAULT_ORG_NAME',
        ).strip()
        or DEFAULT_ORG_NAME,
        auto_add_users=_env_truthy(
            'OMNIAGENT_DEFAULT_ORG_AUTO_ADD_USERS',
