...
class OrgStore:
    ...
    def get_agent_settings_from_org(org: Org) -> AgentSettingsConfig:
        ...
        # ``ACPAgentSettings``, not coerced into the OmniAgent shape — that
    ...
    def _merge_and_validate_settings(
        ...
        (OmniAgent or ACP) rather than a coerced OmniAgent shape.
        """
    ...
    async def _maybe_get_managed_llm_key_for_user(
        ...
        # deleting any prior key first — symmetric across omniagent/* and BYOR
