...
from omniagent.app_server.middleware import LocalhostCORSMiddleware

ALLOWED_ORIGIN = 'https://github.com/ismailubts/OmniAgent'
...
class TestApiKeyAwareCORSMiddleware:
    ...
    def test_bearer_request_does_not_inherit_inner_cors_headers_or_warnings(
        ...
        with caplog.at_level(logging.WARNING, logger='omniagent.app_server.middleware'):
            response = client.get(
                '/api/v1/settings',
                headers={
                    'Origin': FOREIGN_ORIGIN,
