...
@pytest.mark.parametrize(
    'message,expected',
    [
        ('OmniAgent/Openhands', ['OmniAgent/Openhands']),
        (
            'help me with repo',
            [],
...
class TestRepoVerificationHandling:
    ...
    async def test_timeout_during_verification_shows_selector(
        ...
        slack_new_conversation_view.user_msg = 'Help me with ismailubts/OmniAgent repo'
    ...
    async def test_verified_repo_starts_job(
        ...
        assert slack_new_conversation_view.selected_repo == 'ismailubts/OmniAgent'
...
class TestUserMsgStorage:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                '1234567890.123456',
                '1234567890.111111',
                'Hello OmniAgent, help me with my code',
            ),
            ('1234567890.123456', None, 'Hello OmniAgent'),
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                b'Hello OmniAgent, help me with my code',
                'Hello OmniAgent, help me with my code',
            ),
            ('Hello OmniAgent', 'Hello OmniAgent'),  # String instead of bytes
        ],
