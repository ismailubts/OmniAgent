...
class TestGetWebUrl:
    ...
    def test_configured_web_url_is_used(self, mock_request):
        ...
        mock_config.web_url = 'https://github.com/ismailubts/OmniAgent'
        ...
        assert result == 'https://github.com/ismailubts/OmniAgent'
...
class TestGetCookieDomain:
    ...
    def test_production_with_configured_web_url(self):
        ...
        assert result == 'app.github.com/ismailubts/OmniAgent'
    ...
    def test_staging_env_returns_none(self):
        ...
        mock_config = MagicMock()
        mock_config.web_url = 'https://staging.github.com/ismailubts/OmniAgent'
    ...
    def test_feature_env_returns_none(self):
        ...
        mock_config = MagicMock()
        mock_config.web_url = 'https://feature-123.staging.github.com/ismailubts/OmniAgent'
...
class TestGetCookieSamesite:
    ...
    def test_feature_env_returns_lax(self):
        ...
        mock_config = MagicMock()
        mock_config.web_url = 'https://feature-xyz.staging.github.com/ismailubts/OmniAgent'
...
class TestSecurityScenarios:
    ...
    def test_cookie_domain_not_set_in_dev_environments(self):
        ...
        mock_config = MagicMock()
        mock_config.web_url = 'https://my-feature.staging.github.com/ismailubts/OmniAgent'
