...
These tests work without OmniAgent dependencies and focus on testing the core
...
class TestMaintenanceTaskRunnerStandalone:
    """Standalone tests for MaintenanceTaskRunner without OmniAgent dependencies."""
