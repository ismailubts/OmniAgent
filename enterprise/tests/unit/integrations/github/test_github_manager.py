...
Covers:
- User not found scenario when a GitHub user hasn't created an OmniAgent account
...
class TestGithubManagerUserNotFound:
    """Test cases for when a valid GitHub user hasn't created an OmniAgent account."""
    ...
    def github_issue_comment_message(self):
        """Create a sample GitHub issue comment message with an @omniagent mention."""
        return Message(
            ...
            message={
                ...
                'payload': {
                    ...
                    'comment': {
                        'body': '@omniagent please help with this issue',
                    },
                },
            },
        )
        ...
        return Message(
            ...
            message={
                ...
                'payload': {
                    ...
                    'comment': {
                        'body': '@omniagent please review this PR',
                    },
                },
            },
        )
    ...
    def test_send_user_not_found_message_for_issue(
        ...
        """Test that a sign-up message is sent when a valid user hasn't created an OmniAgent account on an issue."""
        # Set up mocks
        ...
        assert "haven't created an OmniAgent account" in comment_text
    ...
    def test_send_user_not_found_message_for_pr(
        ...
        """Test that a sign-up message is sent when a valid user hasn't created an OmniAgent account on a PR."""
        # Set up mocks
        mock_github_instance = MagicMock()
        mock_github_class.return_value.__enter__ = MagicMock(
            return_value=mock_github_instance
    ...
    async def test_is_job_requested_ignores_openhands_bot_sender(
        ...
        """Test that bot-authored comments from the OmniAgent GitHub App do not start jobs."""
        ...
        github_issue_message.message['payload']['comment']['body'] = (
            'Documented upstream changes in @omniagent/extensions.'
        )
...
class TestGetUserNotFoundMessageIntegration:
    ...
    def test_message_mentions_openhands_cloud(self):
        """Test that the message directs users to OmniAgent Cloud."""
        message = get_user_not_found_message('testuser')
        assert 'OmniAgent Cloud' in message
