...
class TestGithubLabels(TestCase):
    def test_labels_with_staging(self):
        oh_label, inline_oh_label = get_oh_labels('staging.github.com/ismailubts/OmniAgent')
        self.assertEqual(oh_label, 'openhands-exp')
        self.assertEqual(inline_oh_label, '@omniagent-exp')

    def test_labels_with_staging_v2(self):
        oh_label, inline_oh_label = get_oh_labels('main.staging.github.com/ismailubts/OmniAgent')
        self.assertEqual(oh_label, 'openhands-exp')
        self.assertEqual(inline_oh_label, '@omniagent-exp')
    ...
    def test_labels_with_prod(self):
        oh_label, inline_oh_label = get_oh_labels('app.github.com/ismailubts/OmniAgent')
        self.assertEqual(oh_label, 'openhands')
        self.assertEqual(inline_oh_label, '@omniagent')
    ...
    def test_labels_with_override(self):
        ...
        self.assertEqual(inline_oh_label, '@omniagent-dev')
...
class TestGithubCommentCaseInsensitivity(TestCase):
    @mock.patch('integrations.github.github_view.INLINE_OH_LABEL', '@omniagent')
    def test_issue_comment_case_insensitivity(self):
        ...
        message_lower = Message(
            ...
            message={
                'payload': {
                    'action': 'created',
                    'comment': {'body': 'hello @omniagent please help'},
                    'issue': {'number': 1},
                }
            },
        )
