...
class TestProvisionUserHandler:
    ...
    async def test_personal_workspace_rejected_with_403(
        ...
        provision additional Keycloak/OmniAgent accounts inside
    ...
    async def test_rollback_before_user_created_only_cleans_keycloak(
        ...
        so when it blows up there are no OmniAgent DB rows to
        ...
        # but before any OmniAgent DB row was created.
