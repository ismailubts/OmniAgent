...
DEFAULT_FROM_EMAIL = 'OmniAgent <no-reply@users.noreply.github.com>'
DEFAULT_WEB_HOST = 'https://github.com/ismailubts/OmniAgent'
...
class SMTPEmailService:
    ...
    def send_invitation_email(
        ...
        subject = f"You're invited to join {org_name} on OmniAgent"
        body = f"""
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <p>Hi,</p>

            <p><strong>{inviter_name}</strong> has invited you to join <strong>{org_name}</strong> on OmniAgent as a <strong>{role_name}</strong>.</p>
    ...
    def send_budget_alert_email(
        ...
        subject = (
            f'OmniAgent budget alert: {org_name} reached {threshold}% of its limit'
        )
        body = f"""
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <p>Hi,</p>
            ...
            <hr style="border: none; border-top: 1px solid #eee; margin: 30px 0;">
            <p style="color: #999; font-size: 12px;">Best,<br>The OmniAgent Team</p>
        </div>
        """
