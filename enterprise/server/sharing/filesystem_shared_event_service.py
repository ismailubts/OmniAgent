...
from omniagent.app_server.event.filesystem_event_service import FilesystemEventService
from omniagent.app_server.event_callback.event_callback_models import EventKind
...
class FilesystemSharedEventServiceInjector(SharedEventServiceInjector):
    async def inject(
        ...
        from omniagent.app_server.config import get_db_session
