...
from omniagent.app_server.config import depends_jwt_service
...
async def keycloak_callback(
    ...
    if not keycloak_access_token or not keycloak_refresh_token:
        ...
        return _html_response(
            ...
            description=f'Please re-login into <a href="{HOST_URL}" style="color:#ecedee;text-decoration:underline;">OmniAgent Cloud</a>. Then try <a href="https://github.com/ismailubts/OmniAgent/blob/main/README.md" style="color:#ecedee;text-decoration:underline;">installing the OmniAgent Slack App</a> again',
            status_code=400,
        )
        ...
        if e.response.get('error') == 'missing_scope':
            ...
            return _html_response(
                ...
                description=(
                    ...
                    f'Please <a href="{HOST_URL}/slack/install" style="color:#ecedee;text-decoration:underline;">re-install the OmniAgent Slack App</a> '
    ...
    return _html_response(
        title='OmniAgent Authentication Successful!',
