"""Resolve which OmniAgent organization workspace a resolver conversation should be created in.

This module provides a reusable utility for routing resolver conversations
(GitHub, GitLab, Bitbucket, Slack, etc.) to the correct OmniAgent organization
...
async def resolve_org_for_repo(
    ...
    """Determine the OmniAgent org_id for a resolver conversation.

    If the repo's git organization is claimed by an OmniAgent org, returns the
    ...
    Args:
        ...
        full_repo_name: Full repository name (e.g., "OmniAgent/foo")
