...
class JiraPayloadParser:
    ...
    def __init__(self, oh_label: str, inline_oh_label: str):
        """Initialize parser with OmniAgent label configuration.

        Args:
            oh_label: Label that triggers OmniAgent (e.g., 'openhands')
            inline_oh_label: Mention that triggers OmniAgent (e.g., '@omniagent')
        """
    ...
    def _has_mention(self, text: str) -> bool:
        """Check if text contains an exact mention of OmniAgent."""
