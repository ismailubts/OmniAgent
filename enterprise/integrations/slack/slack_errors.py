...
_USER_MESSAGES: dict[SlackErrorCode, str] = {
    ...
    SlackErrorCode.USER_NOT_AUTHENTICATED: (
        '🔐 Please link your Slack account to OmniAgent: '
    ...
    SlackErrorCode.PROVIDER_AUTH_FAILED: (
        ...
        f'Please re-login at [OmniAgent Cloud]({HOST_URL}) and try again.'
    ),
    ...
    SlackErrorCode.MISSING_SLACK_SCOPES: (
        ...
        f'Please ask your workspace admin to re-install the OmniAgent Slack App at {HOST_URL}/slack/install '
