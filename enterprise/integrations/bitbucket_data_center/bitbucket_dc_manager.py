...
class BitbucketDCManager(Manager[BitbucketDCViewType]):
    ...
    def __init__(
        ...
        self.jinja_env = Environment(
            loader=FileSystemLoader(OMNIAGENT_RESOLVER_TEMPLATES_DIR + 'bitbucket')
        )
    ...
    async def receive_message(self, message: Message) -> None:
        ...
        # we'd risk re-firing the webhook on our own "@omniagent" comment, so skip
        ...
        # the bot PAT and can contain "@omniagent"; without this guard it would
