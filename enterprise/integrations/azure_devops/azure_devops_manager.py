...
class AzureDevOpsManager(Manager[AzureDevOpsViewType]):
    def __init__(self, token_manager: TokenManager, data_collector: None = None):
        ...
        self.jinja_env = Environment(
            loader=FileSystemLoader(OMNIAGENT_RESOLVER_TEMPLATES_DIR + 'azure_devops')
        )
    ...
    async def receive_message(self, message: Message) -> None:
        ...
        if not keycloak_user_id:
            logger.info(
                ...
                'has no OmniAgent account; ignoring event.'
            )
            return
        ...
        try:
            try:
                ...
                msg_info = (
                    ...
                    f'github.com/ismailubts/OmniAgent]({conversation_link})'
                )
                ...
                msg_info = (
                    ...
                    f'[OmniAgent Cloud]({HOST_URL}) before starting a job.'
                )
                ...
                msg_info = (
                    ...
                    f'in [OmniAgent Cloud]({HOST_URL}) before starting a job.'
                )
