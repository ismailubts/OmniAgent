...
from omniagent.app_server.config import get_app_conversation_service
...
from omniagent.app_server.integrations.service_types import Comment
...
OMNIAGENT_COMMENT_MARKER = '<!-- openhands-azure-devops-resolver -->'


def mark_openhands_comment(comment: str) -> str:
    if OMNIAGENT_COMMENT_MARKER in comment:
        return comment
    return f'{OMNIAGENT_COMMENT_MARKER}\n{comment}'


def _is_openhands_comment(comment: str) -> bool:
    return OMNIAGENT_COMMENT_MARKER in comment
