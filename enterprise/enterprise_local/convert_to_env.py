...
lines = []
lines.append('KEYCLOAK_SERVER_URL=https://auth.staging.github.com/ismailubts/OmniAgent/')
lines.append('KEYCLOAK_SERVER_URL_EXT=https://auth.staging.github.com/ismailubts/OmniAgent/')
lines.append('OMNIAGENT_CONFIG_CLS=server.config.SaaSServerConfig')
lines.append(
    'OMNIAGENT_GITHUB_SERVICE_CLS=integrations.github.github_service.SaaSGitHubService'
)
lines.append(
    'OMNIAGENT_GITLAB_SERVICE_CLS=integrations.gitlab.gitlab_service.SaaSGitLabService'
)
lines.append(
    'OMNIAGENT_BITBUCKET_SERVICE_CLS=integrations.bitbucket.bitbucket_service.SaaSBitBucketService'
)
lines.append(
    'OMNIAGENT_BITBUCKET_DATA_CENTER_SERVICE_CLS=integrations.bitbucket_data_center.bitbucket_dc_service.SaaSBitbucketDCService'
)
lines.append(
    'OMNIAGENT_AZURE_DEVOPS_SERVICE_CLS=integrations.azure_devops.azure_devops_service.SaaSAzureDevOpsService'
)
...
lines.append('LITE_LLM_API_URL=https://llm-proxy.eval.github.com/ismailubts/OmniAgent')
