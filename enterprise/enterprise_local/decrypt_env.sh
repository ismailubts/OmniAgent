...
decrypt_and_move "omniagent/envs/feature/secrets/github-app.yaml" "github_decrypted.yaml"
decrypt_and_move "omniagent/envs/staging/secrets/keycloak-realm.yaml" "keycloak_realm_decrypted.yaml"
decrypt_and_move "omniagent/envs/staging/secrets/keycloak-admin.yaml" "keycloak_admin_decrypted.yaml"
