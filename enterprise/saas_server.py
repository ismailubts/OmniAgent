...
if not os.getenv('OMNIAGENT_CONFIG_CLS'):
    os.environ['OMNIAGENT_CONFIG_CLS'] = 'server.config.SaaSServerConfig'
...
from omniagent.app_server.app import app as base_app  # noqa: E402
from omniagent.app_server.middleware import (  # noqa: E402
    CacheControlMiddleware,
)
from omniagent.app_server.static import SPAStaticFiles  # noqa: E402
