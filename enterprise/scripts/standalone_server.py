...
# Create FastAPI app
app = FastAPI(title='OmniAgent Admin API', version='1.0.0')
...
@app.get('/')
async def root():
    return {'message': 'OmniAgent Admin API', 'docs': '/docs'}
...
<head>
    ...
    <title>OmniAgent Admin Dashboard</title>
    <style>
...
<body>
    <div class="container">
        <header>
            <h1>🎯 OmniAgent Admin Dashboard</h1>
