...
# This file is part of the legacy (V0) implementation of OmniAgent and will be removed soon as we complete the migration to V1.
# OmniAgent V1 uses the Software Agent SDK for the agentic core and runs a new application server. Please refer to:
#   - V1 agentic core (SDK): https://github.com/OmniAgent/software-agent-sdk
#   - V1 application server (in this repo): omniagent/app_server/
# Unless you are working on deprecation, please avoid extending this legacy file and consult the V1 codepaths above.
# Tag: Legacy-V0
# This module belongs to the old V0 web server. The V1 application server lives under omniagent/app_server/.
...
from omniagent.app_server.integrations.provider import (
    PROVIDER_TOKEN_TYPE,
    ProviderHandler,
)
...
class UserAuth(ABC):
    ...
    This is an extension point in OmniAgent that allows applications to provide their own
    ...
    The class is instantiated via get_impl() in omniagent.app_server.shared.py.
    """
