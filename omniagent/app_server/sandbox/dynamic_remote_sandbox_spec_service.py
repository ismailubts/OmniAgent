...
from omniagent.app_server.sandbox.sandbox_spec_models import (
    SandboxSpecInfo,
    SandboxSpecInfoPage,
)
...
class DynamicRemoteSandboxSpecServiceInjector(SandboxSpecServiceInjector):
    ...
    Enable via environment variable:
        OH_SANDBOX_SPEC_KIND=omniagent.app_server.sandbox.dynamic_remote_sandbox_spec_service.DynamicRemoteSandboxSpecServiceInjector
