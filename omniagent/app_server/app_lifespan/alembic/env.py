...
# Add the project root to the Python path so we can import OmniAgent modules
# From alembic/env.py, we need to go up 5 levels to reach the OmniAgent project root
...
from omniagent.app_server.app_conversation.sql_app_conversation_info_service import (  # noqa: E402
    StoredConversationMetadata,  # noqa: F401
)
from omniagent.app_server.app_conversation.sql_app_conversation_start_task_service import (  # noqa: E402
    StoredAppConversationStartTask,  # noqa: F401
)
from omniagent.app_server.config import get_global_config  # noqa: E402
from omniagent.app_server.event_callback.sql_event_callback_service import (  # noqa: E402
    StoredEventCallback,  # noqa: F401
)
from omniagent.app_server.sandbox.remote_sandbox_service import (  # noqa: E402
    StoredRemoteSandbox,  # noqa: F401
)
from omniagent.app_server.utils.sql_utils import Base  # noqa: E402
...
def run_migrations_offline() -> None:
    ...
    if db_session.host:
        ...
        url = f'sqlite:///{db_session.persistence_dir}/omniagent.db'
