"""Secrets router for OmniAgent App Server.
...
from omniagent.app_server.secrets.secrets_models import (
    CustomSecretCreate,
    CustomSecretPage,
...
from omniagent.app_server.utils.models import EditResponse
...
async def search_custom_secrets(
    ...
    In SaaS mode, includes the system-generated OMNIAGENT_API_KEY which cannot be deleted.
