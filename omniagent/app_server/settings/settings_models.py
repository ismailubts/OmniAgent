"""Settings models for OmniAgent App Server.

This module contains:
- Settings: Persisted settings for OmniAgent sessions
...
from omniagent.app_server.utils.jsonpatch_compat import deep_merge
...
def _load_persisted_agent_settings(
    ...
    ``agent_kind: 'llm'`` tag to ``'openhands'`` (SDK contract; displayed as OmniAgent), and validates against the
...
class Settings(BaseModel):
    """Persisted settings for OmniAgent sessions.
    ...
    def update(self, payload: dict[str, Any]) -> None:
        ...
        if isinstance(agent_update, dict):
            ...
            # config preservation tracked in ismailubts/OmniAgent#14370.
