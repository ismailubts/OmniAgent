"""Settings router for OmniAgent App Server.
...
from omniagent.analytics import get_analytics_service
...
from omniagent.app_server.settings.llm_profiles import (
...
from omniagent.app_server.utils.llm import (
...
def _post_merge_llm_fixups(settings: Settings) -> None:
    ...
    rules to :func:`omniagent.app_server.utils.llm.resolve_llm_base_url` so the
