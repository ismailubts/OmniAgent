...
from omniagent.app_server.utils.llm import resolve_llm_base_url
...
class StrictLLM(LLM):
    ...
    def _restore_is_subscription(cls, data: Any, handler: Any) -> Any:
        ...
        See OmniAgent/software-agent-sdk#3942.
...
class LLMProfiles(BaseModel):
    ...
    def summaries(
        ...
        value the profile will actually use at runtime for public OmniAgent
        provider profiles.
        """
        return [
            {
