...
The Agent-Profile analogue of :class:`~omniagent.app_server.settings.llm_profiles.LLMProfiles`,
...
_AgentProfile: TypeAlias = OmniAgentAgentProfile | ACPAgentProfile
...
class AgentProfiles(BaseModel):
            ...
            summaries.append(
                {
                    ...
                    'llm_profile_ref': (
                        ...
                        if isinstance(profile, OmniAgentAgentProfile)
                        else None
                    ),
    ...
    def set_llm_profile_ref(self, name: str, new_ref: str) -> None:
        """Repoint one OmniAgent profile's ``llm_profile_ref`` (the FK cascade
