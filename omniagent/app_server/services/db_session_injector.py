"""Database configuration and session management for OmniAgent App Server."""
...
from omniagent.db.ssl import build_asyncpg_connect_args, build_pg8000_connect_args
...
class DbSessionInjector(BaseModel, Injector[AsyncSession]):
    ...
    def fill_empty_fields(self):
        ...
        if self.name is None:
            self.name = os.getenv('DB_NAME', 'omniagent')
    ...
    async def get_async_db_engine(self) -> AsyncEngine:
        ...
        if self.gcp_db_instance:  # GCP environments
            ...
            if self.host:
                ...
                url = f'sqlite+aiosqlite:///{str(self.persistence_dir)}/omniagent.db'
    ...
    def get_db_engine(self) -> Engine:
        ...
        if self.gcp_db_instance:  # GCP environments
            ...
            if self.host:
                ...
                url = f'sqlite:///{self.persistence_dir}/omniagent.db'
            engine = create_engine(
                url,
