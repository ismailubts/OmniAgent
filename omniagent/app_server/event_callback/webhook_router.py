"""Event Callback router for OmniAgent App Server."""
...
from omniagent.app_server import shared
...
from omniagent.app_server.errors import AuthError
...
from omniagent.app_server.event_callback.event_callback_result_models import (
...
from omniagent.app_server.sandbox.sandbox_models import SandboxRecord
...
from omniagent.app_server.user.auth_user_context import AuthUserContext
from omniagent.app_server.user.specifiy_user_context import (
    ADMIN,
    USER_CONTEXT_ATTR,
    SpecifyUserContext,
)
from omniagent.app_server.user_auth.default_user_auth import DefaultUserAuth
from omniagent.app_server.user_auth.user_auth import (
...
async def on_conversation_update(
    ...
    union so both OmniAgent (``Agent``) and ACP (``ACPAgent``) payloads are
