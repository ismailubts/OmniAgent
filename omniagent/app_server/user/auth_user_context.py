...
from omniagent.app_server.user_auth.user_auth import UserAuth, get_user_auth
...
class AuthUserContext(UserContext):
    ...
    async def get_user_id(self) -> str | None:
        ...
        # it means we are in OmniAgent (OSS mode).
    ...
    async def get_secrets(self) -> dict[str, SecretSource]:
        ...
        # Include custom secrets (includes OMNIAGENT_API_KEY in SaaS mode)
