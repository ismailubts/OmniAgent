...
from omniagent.app_server.web_client.web_client_deployment_mode import (
    DeploymentMode,
    get_deployment_mode,
)
...
class WebClientFeatureFlags(BaseModel):
    ...
    # visible on SaaS and existing installs, matching OmniAgent. Set
...
class WebClientConfig(DiscriminatedUnionMixin):
    ...
    # Optional OmniAgent Enterprise/KOTS-managed Jira DC service account. When
