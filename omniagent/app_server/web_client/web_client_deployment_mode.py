...
def get_deployment_mode() -> DeploymentMode | None:
    ...
    if not web_host:
        return None
    if (
        web_host == 'app.github.com/ismailubts/OmniAgent'
        or web_host == 'app.omniagent.ai'
        or web_host.endswith('.github.com/ismailubts/OmniAgent')
        or web_host.endswith('.omniagent.ai')
    ):
        return 'cloud'
    return 'self_hosted'
