...
class OmniAgentError(HTTPException):
    """General Error"""
...
class AuthError(OmniAgentError):
...
class PermissionsError(OmniAgentError):
...
class SandboxError(OmniAgentError):
    """Error in Sandbox."""


class SandboxDeleteRetryError(OmniAgentError):
