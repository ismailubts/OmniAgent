# OmniAgent App Server

FastAPI-based application server that provides REST API endpoints for OmniAgent V1 integration.

## Overview

This package provides server and sandbox functionality to interact with the OmniAgent Software Agent SDK. It exposes REST API endpoints for managing conversations, sandboxes, events, and user settings.
