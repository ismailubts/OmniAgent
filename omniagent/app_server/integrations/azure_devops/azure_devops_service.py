...
from omniagent.app_server.integrations.azure_devops.service.branches import (
    AzureDevOpsBranchesMixin,
)
from omniagent.app_server.integrations.azure_devops.service.features import (
    AzureDevOpsFeaturesMixin,
)
from omniagent.app_server.integrations.azure_devops.service.prs import (
    AzureDevOpsPRsMixin,
)
from omniagent.app_server.integrations.azure_devops.service.repos import (
    AzureDevOpsReposMixin,
)
from omniagent.app_server.integrations.azure_devops.service.resolver import (
    AzureDevOpsResolverMixin,
)
from omniagent.app_server.integrations.azure_devops.service.webhooks import (
    AzureDevOpsWebhooksMixin,
)
from omniagent.app_server.integrations.azure_devops.service.work_items import (
    AzureDevOpsWorkItemsMixin,
)
from omniagent.app_server.integrations.protocols.http_client import HTTPClient
from omniagent.app_server.integrations.service_types import (
    BaseGitService,
    GitService,
    ProviderType,
    RequestMethod,
...
class AzureDevOpsService(
    ...
    This is an extension point in OmniAgent that allows applications to customize Azure DevOps
    integration behavior. Applications can substitute their own implementation by:
    1. Creating a class that inherits from GitService
    2. Implementing all required methods
    3. Setting OMNIAGENT_AZURE_DEVOPS_SERVICE_CLS environment variable
...
azure_devops_service_cls = os.environ.get(
    'OMNIAGENT_AZURE_DEVOPS_SERVICE_CLS',
    'omniagent.app_server.integrations.azure_devops.azure_devops_service.AzureDevOpsService',
)
