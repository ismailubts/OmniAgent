...
from omniagent.app_server.integrations.gitlab.service import (
    GitLabBranchesMixin,
    GitLabFeaturesMixin,
    GitLabPRsMixin,
    GitLabReposMixin,
...
class GitLabService(
    ...
    This is an extension point in OmniAgent that allows applications to customize GitLab
...
gitlab_service_cls = os.environ.get(
    'OMNIAGENT_GITLAB_SERVICE_CLS',
    'omniagent.app_server.integrations.gitlab.gitlab_service.GitLabService',
)
