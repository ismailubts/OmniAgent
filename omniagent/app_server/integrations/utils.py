...
from omniagent.app_server.integrations.forgejo.forgejo_service import ForgejoService
from omniagent.app_server.integrations.github.github_service import GitHubService
from omniagent.app_server.integrations.gitlab.gitlab_service import GitLabService
