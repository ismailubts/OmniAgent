...
from omniagent.app_server.integrations.bitbucket_data_center.service import (
...
class BitbucketDCService(
    ...
    This is an extension point in OmniAgent that allows applications to customize Bitbucket data center
...
bitbucket_dc_service_cls = os.environ.get(
    'OMNIAGENT_BITBUCKET_DATA_CENTER_SERVICE_CLS',
    'omniagent.app_server.integrations.bitbucket_data_center.bitbucket_dc_service.BitbucketDCService',
)
