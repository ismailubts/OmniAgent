...
from omniagent.app_server.integrations.bitbucket_data_center.service.base import (
...
class BitbucketDCResolverMixin(BitbucketDCMixinBase):
    ...
    async def get_pr_comments(
        ...
        Args:
            ...
            exclude_comment_id: Comment id to omit from the returned context,
                usually the triggering @omniagent comment.
    ...
    async def user_has_write_access_for(
        ...
        global) requires admin per Atlassian's docs. The OmniAgent OAuth
        ...
        ``omniagent/app_server/integrations/bitbucket/service/resolver.py``),
