...
from omniagent.app_server.integrations.forgejo.service import (
...
forgejo_service_cls = os.environ.get(
    'OMNIAGENT_FORGEJO_SERVICE_CLS',
    'omniagent.app_server.integrations.forgejo.forgejo_service.ForgejoService',
)
