...
from omniagent.app_server.integrations.bitbucket.service import (
...
class BitBucketService(
    ...
    This is an extension point in OmniAgent that allows applications to customize Bitbucket
...
bitbucket_service_cls = os.environ.get(
    'OMNIAGENT_BITBUCKET_SERVICE_CLS',
    'omniagent.app_server.integrations.bitbucket.bitbucket_service.BitBucketService',
)
