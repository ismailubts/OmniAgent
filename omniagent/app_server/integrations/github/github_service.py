...
from omniagent.app_server.integrations.github.service import (
    GitHubBranchesMixin,
    GitHubFeaturesMixin,
    GitHubPRsMixin,
    GitHubReposMixin,
...
class GitHubService(
    ...
    This is an extension point in OmniAgent that allows applications to customize GitHub
...
github_service_cls = os.environ.get(
    'OMNIAGENT_GITHUB_SERVICE_CLS',
    'omniagent.app_server.integrations.github.github_service.GitHubService',
)
