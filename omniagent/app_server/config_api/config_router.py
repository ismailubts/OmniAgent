"""Config router for OmniAgent App Server V1 API.
...
from omniagent.app_server.config import depends_llm_model_service
from omniagent.app_server.config_api.config_models import LLMModelPage, ProviderPage
...
async def search_providers(
    ...
    Each provider indicates whether it is verified by OmniAgent.
    """
