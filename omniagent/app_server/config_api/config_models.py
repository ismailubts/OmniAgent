"""Config-related models for OmniAgent App Server V1 API."""
...
class LLMModel(BaseModel):
    ...
    verified: bool = Field(
        default=False, description='Whether the model is verified by OmniAgent'
    )
    hidden: bool = Field(
        default=False,
        description=(
...
class Provider(BaseModel):
    ...
    verified: bool = Field(
        default=False, description='Whether the provider is verified by OmniAgent'
    )
