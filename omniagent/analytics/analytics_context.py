...
the get_impl() pattern used throughout OmniAgent. Enterprise deployments provide
...
from omniagent.analytics.user_base import UserBase
from omniagent.analytics.user_provider import AnalyticsUserProvider
