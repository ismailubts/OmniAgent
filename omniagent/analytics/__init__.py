"""OmniAgent analytics package.

Provides a module-level singleton pattern for the AnalyticsService.

Usage::

    from omniagent.analytics import init_analytics_service, get_analytics_service
...
from omniagent.analytics.analytics_context import (
    AnalyticsContext,
    resolve_analytics_context,
)
from omniagent.analytics.analytics_service import AnalyticsService
