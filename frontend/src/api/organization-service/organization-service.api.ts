...
export const organizationService = {
  getMe: async ({ orgId }: { orgId: string }) => {
    const { data } = await omniAgentApi.get<OrganizationMember>(
  ...
  getOrganizations: async () => {
    const { data } = await omniAgentApi.get<{
      items: Organization[];
  ...
  updateOrganization: async ({
    ...
    const { data } = await omniAgentApi.patch<Organization>(
  ...
  deleteOrganization: async ({ orgId }: { orgId: string }) => {
    await omniAgentApi.delete(`/api/organizations/${orgId}`);
  },
  ...
  getOrganizationMembers: async ({
    ...
    const { data } = await omniAgentApi.get<OrganizationMembersPage>(
  ...
  getOrganizationMembersCount: async ({
    ...
    const { data } = await omniAgentApi.get<number>(
  ...
  updateMember: async ({
    ...
    const { data } = await omniAgentApi.patch(
  ...
  removeMember: async ({
    ...
    await omniAgentApi.delete(`/api/organizations/${orgId}/members/${userId}`);
  },
  ...
  inviteMembers: async ({
    ...
    const { data } = await omniAgentApi.post<BatchInvitationResult>(
  ...
  getPendingInvitations: async ({ orgId }: { orgId: string }) => {
    const { data } = await omniAgentApi.get<PendingInvitationsPage>(
      `/api/organizations/${orgId}/members/invite`,
    );
  ...
  acceptInvitation: async ({ token }: { token: string }) => {
    const { data } = await omniAgentApi.post<{
      success: boolean;
      org_id: string;
      org_name: string;
      role: string;
  ...
  getOrganizationSettings: async ({ orgId }: { orgId: string }) => {
    const { data } = await omniAgentApi.get<OrganizationSettingsResponse>(
  ...
  saveOrganizationSettings: async ({
    ...
    const { data } = await omniAgentApi.patch<OrganizationSettingsResponse>(
      `/api/organizations/${orgId}/settings`,
      settings,
    );
    return data;
  ...
  getGitClaims: async ({ orgId }: { orgId: string }) => {
    const { data } = await omniAgentApi.get<GitOrgClaim[]>(
  ...
  claimGitOrg: async ({
    ...
    const { data } = await omniAgentApi.post<GitOrgClaim>(
      `/api/organizations/${orgId}/git-claims`,
  ...
  disconnectGitOrg: async ({
    ...
    await omniAgentApi.delete(`/api/organizations/${orgId}/git-claims/${claimId}`);
  },

  getOrganizationAppSettings: async () => {
    const { data } = await omniAgentApi.get<OrganizationAppSettingsResponse>(
  ...
  saveOrganizationAppSettings: async (
    ...
    const { data } = await omniAgentApi.post<OrganizationAppSettingsResponse>(
      "/api/organizations/app",
      settings,
    );
    return data;
  ...
  getConversationStats: async ({ orgId }: { orgId: string }) => {
    const { data } = await omniAgentApi.get<OrgConversationStats>(
  ...
  getUsageStats: async ({
    ...
    const { data } = await omniAgentApi.get<OrgUsageStats>(
  ...
  getUserUsageStats: async ({
    ...
    const { data } = await omniAgentApi.get<OrgUserUsageStats>(
  ...
  getBudgetSettings: async ({
    ...
    const { data } = await omniAgentApi.get<OrgBudgetSettings>(
  ...
  updateBudgetSettings: async ({
    ...
    const { data } = await omniAgentApi.patch<OrgBudgetSettings>(
      `/api/organizations/${orgId}/budgets`,
      payload,
    );
    return data;
  ...
  upsertBudgetOverride: async ({
    ...
    const { data } = await omniAgentApi.put<OrgBudgetUser>(
  ...
  getConversations: async ({
    ...
    const { data } = await omniAgentApi.get<OrgConversationPage>(
  ...
  getConversation: async ({
    ...
    const { data } = await omniAgentApi.get<OrgConversationResponse>(
