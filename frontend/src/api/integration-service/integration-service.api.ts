...
export const integrationService = {
  ...
  getGitLabResources: async (): Promise<GitLabResourcesResponse> => {
    const { data } = await omniAgentApi.get<GitLabResourcesResponse>(
  ...
  reinstallGitLabWebhook: async ({
    ...
    const { data } = await omniAgentApi.post<ResourceInstallationResult>(
  ...
  getBitbucketDCResources: async (): Promise<BitbucketDCResourcesResponse> => {
    const { data } = await omniAgentApi.get<BitbucketDCResourcesResponse>(
  ...
  /**
   * Enroll a Bitbucket Data Center repository webhook in OmniAgent.
  ...
  enrollBitbucketDCWebhook: async ({
    ...
    const { data } = await omniAgentApi.post<BitbucketDCWebhookEnrollmentResult>(
  ...
  updateBitbucketDCWebhookId: async ({
    ...
    const { data } = await omniAgentApi.patch<BitbucketDCWebhookIdUpdateResult>(
  ...
  reinstallBitbucketDCWebhook: async ({
    ...
    const { data } = await omniAgentApi.post<BitbucketDCWebhookInstallationResult>(
  ...
  getAzureDevOpsResources: async (): Promise<AzureDevOpsWebhookStatus> => {
    const { data } = await omniAgentApi.get<AzureDevOpsWebhookStatus>(
  ...
  reinstallAzureDevOpsWebhook:
    async (): Promise<AzureDevOpsWebhookInstallationResult> => {
      const { data } =
        await omniAgentApi.post<AzureDevOpsWebhookInstallationResult>(
