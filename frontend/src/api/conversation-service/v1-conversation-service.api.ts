...
import { ConversationTrigger, GetVSCodeUrlResponse } from "../omniagent-api.types";
...
class V1ConversationService {
  ...
  static async sendMessage(
    ...
    const { data } = await omniAgentApi.post<V1SendMessageResponse>(
  ...
  static async createConversation(
    ...
    const { data } = await omniAgentApi.post<V1AppConversationStartTask>(
  ...
  static async getStartTask(
    ...
    const { data } = await omniAgentApi.get<(V1AppConversationStartTask | null)[]>(
  ...
  static async searchStartTasks(
    ...
    const { data } = await omniAgentApi.get<V1AppConversationStartTaskPage>(
  ...
  static async batchGetAppConversations(
    ...
    const { data } = await omniAgentApi.get<(V1AppConversation | null)[]>(
  ...
  static async getConversationConfig(
    ...
    const { data } = await omniAgentApi.get<{ runtime_id: string }>(url);
    return data;
  }
  ...
  static async updateConversationPublicFlag(
    ...
    const { data } = await omniAgentApi.patch<V1AppConversation>(
  ...
  static async readConversationFile(
    ...
    const { data } = await omniAgentApi.get<string>(
  ...
  static async downloadConversation(conversationId: string): Promise<Blob> {
    const response = await omniAgentApi.get(
  ...
  static async getSkills(conversationId: string): Promise<GetSkillsResponse> {
    const { data } = await omniAgentApi.get<GetSkillsResponse>(
  ...
  static async getHooks(conversationId: string): Promise<GetHooksResponse> {
    const { data } = await omniAgentApi.get<GetHooksResponse>(
  ...
  static async searchConversationsBySandboxId(
    ...
    const { data } = await omniAgentApi.get<V1AppConversationPage>(
  ...
  static async deleteConversation(conversationId: string): Promise<void> {
    await omniAgentApi.delete(`/api/v1/app-conversations/${conversationId}`);
  }
