...
import type { OmniAgentParsedEvent } from "#/types/core";
import { isObservationEvent } from "#/types/v1/type-guards";
import type { OmniAgentEvent } from "#/types/v1/core";
...
function getTaskListFromEvent(event: OHEvent): TaskListItem[] | null {
  ...
  const v0 = event as OmniAgentParsedEvent;
  ...
  const v1 = event as OmniAgentEvent;
  if (
