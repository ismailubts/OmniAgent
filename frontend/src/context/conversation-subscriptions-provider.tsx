...
interface ConversationSubscriptionsContextType {
  ...
  getEventsForConversation: (conversationId: string) => OmniAgentParsedEvent[];
}
...
const isAgentStatusError = (event: unknown): event is OmniAgentParsedEvent =>
  isOmniAgentEvent(event) &&
