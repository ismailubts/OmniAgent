...
/**
 * Checks if an error message indicates an OmniAgent budget or credit limit issue.
 * Provider-side errors can also mention "credits"; those should stay as raw
 * provider errors instead of being rewritten as OmniAgent billing failures.
 */
