 ...
 * @example
 * const raw =
 *  "web_scraper.py\r\n\r\n[Python Interpreter: /omniagent/poetry/openhands-5O4_aCHf-py3.12/bin/python]\nomniagent@workspace:/workspace $ ";
 *
 * const parsed = parseTerminalOutput(raw);
 *
 * console.log(parsed.output); // web_scraper.py
 * console.log(parsed.symbol); // omniagent@workspace:/workspace $
 */
