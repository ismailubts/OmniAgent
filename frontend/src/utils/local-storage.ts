...
export const LOCAL_STORAGE_KEYS = {
  LOGIN_METHOD: "omniagent_login_method",
  ENTERPRISE_FORM_SAAS: "omniagent_enterprise_form_saas",
  ENTERPRISE_FORM_SELF_HOSTED: "omniagent_enterprise_form_self_hosted",
  SELECTED_ORG: "omniagent_selected_org",
};
