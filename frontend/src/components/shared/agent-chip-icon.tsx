import OmniAgentLogoWhite from "#/assets/branding/omniagent-logo-white.svg?react";
 ...
 * glyph: the OmniAgent logo for native conversations, and the relevant provider
...
export function AgentChipIcon({
  ...
  switch (kind) {
    case "openhands":
      return (
        <OmniAgentLogoWhite width={SIZE} height={SIZE} className={className} />
      );
