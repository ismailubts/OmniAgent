    ...
    <ModalBackdrop onClose={handleClose}>
      <ModalBody className="items-start border border-tertiary w-96">
          ...
          {showConfigurationFields ? (
            <Trans
              ...
              components={{
                ...
                a: (
                  <a
                    href="https://github.com/ismailubts/OmniAgent/blob/main/README.md"
                    target="_blank"
        ...
        <div className="w-full flex flex-col gap-4 mt-1">
          ...
          {showConfigurationFields && (
            <>
              {/* Webhook (Jira -> OmniAgent). Jira DC: auto-install via a
              ...
              {/* Service account (OmniAgent -> Jira): used to post comments and
