...
import { OmniAgentEvent, ObservationEvent, ActionEvent } from "#/types/v1/core";
import {
  isActionEvent,
  isObservationEvent,
  isACPToolCallEvent,
...
const getActionEventTitle = (event: OmniAgentEvent): React.ReactNode => {
...
export const getEventContent = (
  event: OmniAgentEvent | SkillReadyEvent,
  correspondingAction?: ActionEvent,
) => {
