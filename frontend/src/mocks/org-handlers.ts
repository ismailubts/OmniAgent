...
export const MOCK_TEAM_ORG_OMNIAGENT = createMockOrganization(
  "4",
  "OmniAgent",
  750,
);
  ...
  "4": [
    {
      org_id: "3",
      user_id: "6",
      email: "robert@github.com/ismailubts/OmniAgent",
      role: "owner",
      llm_api_key: "**********",
      max_iterations: 20,
      llm_model: "gpt-4",
    ...
    },
    {
      org_id: "3",
      user_id: "7",
      email: "ray@github.com/ismailubts/OmniAgent",
      role: "admin",
      llm_api_key: "**********",
      max_iterations: 20,
      llm_model: "gpt-4",
    ...
    },
    {
      org_id: "3",
      user_id: "8",
      email: "chuck@github.com/ismailubts/OmniAgent",
      role: "member",
      llm_api_key: "**********",
      max_iterations: 20,
      llm_model: "gpt-4",
    ...
    },
    {
      org_id: "3",
      user_id: "9",
      email: "stephan@github.com/ismailubts/OmniAgent",
      role: "member",
      llm_api_key: "**********",
      max_iterations: 20,
      llm_model: "gpt-4",
    ...
    },
    {
      org_id: "3",
      user_id: "10",
      email: "tim@github.com/ismailubts/OmniAgent",
      role: "member",
      llm_api_key: "**********",
      max_iterations: 20,
      llm_model: "gpt-4",
