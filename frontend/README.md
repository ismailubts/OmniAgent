# Getting Started with the OmniAgent Frontend

## Overview

This is the frontend of the OmniAgent project. It is a React application that provides a web interface for the OmniAgent project.
...
1. **Component Testing**
   ...
   - Use our custom [`renderWithProviders()`](https://github.com/ismailubts/OmniAgent/blob/ce26f1c6d3feec3eedf36f823dee732b5a61e517/frontend/test-utils.tsx#L56-L85) that wraps the components we want to test in our providers. It is especially useful for components that use Redux
...
1. **Chat Interface Component Test**:
   [`__tests__/components/chat/chat-interface.test.tsx`](https://github.com/ismailubts/OmniAgent/blob/main/frontend/__tests__/components/chat/chat-interface.test.tsx)
...
2. **Interactive Chat Box Component Test**:
   [`__tests__/components/interactive-chat-box.test.tsx`](https://github.com/ismailubts/OmniAgent/blob/main/frontend/__tests__/components/interactive-chat-box.test.tsx)
