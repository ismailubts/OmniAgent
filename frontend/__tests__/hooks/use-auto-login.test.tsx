...
describe("useAutoLogin", () => {
  const acceptTosUrl =
    "https://ohpr-13306-497.staging.github.com/ismailubts/OmniAgent/accept-tos?redirect_url=" +
    encodeURIComponent(
      "https://ohpr-13306-497.auth.staging.github.com/ismailubts/OmniAgent/realms/allhands/protocol/openid-connect/auth?client_id=allhands&response_type=code",
    );
  ...
  beforeEach(() => {
    ...
    mockUseConfig.mockReturnValue({
      data: {
        app_mode: "saas",
        auth_url: "ohpr-13306-497.auth.staging.github.com/ismailubts/OmniAgent",
      },
      isLoading: false,
    });
