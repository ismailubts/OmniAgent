...
describe("getGitPath", () => {
  ...
  describe("without sandbox grouping (NO_GROUPING)", () => {
    ...
    it("should handle standard owner/repo format (GitHub)", () => {
      expect(getGitPath(conversationId, "ismailubts/OmniAgent", false)).toBe(
        "/workspace/project/OmniAgent",
      );
  ...
  describe("with sandbox grouping enabled", () => {
    ...
    it("should handle standard owner/repo format (GitHub)", () => {
      expect(getGitPath(conversationId, "ismailubts/OmniAgent", true)).toBe(
        `/workspace/project/${conversationId}/OmniAgent`,
      );
