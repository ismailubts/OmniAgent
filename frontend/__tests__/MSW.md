...
> [!NOTE]
> **OmniAgent vs SaaS Mode**
>
> OmniAgent runs in two modes:
> - **OmniAgent mode**: For local/self-hosted deployments where users provide their own LLM API keys and configure git providers manually
