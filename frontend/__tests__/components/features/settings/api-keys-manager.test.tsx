  ...
  return {
    ...
    Trans: ({ i18nKey, components }: { i18nKey: string; components: Record<string, React.ReactNode> }) => {
      ...
      if (i18nKey === "SETTINGS$API_KEYS_DESCRIPTION") {
        return (
          <span>
            API keys allow you to authenticate with the OmniAgent API programmatically.
...
describe("ApiKeysManager", () => {
  ...
  it("should render the API documentation link", () => {
    ...
    expect(link).toHaveAttribute("href", "https://github.com/ismailubts/OmniAgent/blob/main/Development.md");
