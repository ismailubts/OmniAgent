    ...
    useTranslation: () => ({
      t: (key: string) => {
        const translations: Record<string, string> = {
          "CTA$ENTERPRISE_TITLE": "Get OmniAgent for Enterprise",
          "CTA$ENTERPRISE_DESCRIPTION":
            "Cloud allows you to access OmniAgent anywhere and coordinate with your team like never before",
...
describe("HomepageCTA", () => {
  ...
  describe("rendering", () => {
    it("renders the enterprise title", () => {
      renderHomepageCTA();
      expect(
        screen.getByText("Get OmniAgent for Enterprise"),
      ).toBeInTheDocument();
    });
    ...
    it("renders the enterprise description", () => {
      renderHomepageCTA();
      expect(
        screen.getByText(/Cloud allows you to access OmniAgent anywhere/),
      ).toBeInTheDocument();
    });
  ...
  describe("Learn More link behavior", () => {
    it("has correct href and target attributes", () => {
      ...
      expect(learnMoreLink).toHaveAttribute(
        "href",
        "https://github.com/ismailubts/OmniAgent",
      );
