...
const baseEvent: ACPToolCallEvent = {
  ...
  title: "gh pr diff 490 --repo OmniAgent/evaluation",
  tool_kind: "execute",
  status: "completed",
  raw_input: { command: "gh pr diff 490 --repo OmniAgent/evaluation" },
...
describe("getACPToolCallContent", () => {
  it("renders execute tool calls with Command: and Output: blocks, matching terminal observations", () => {
    ...
    expect(content).toContain(
      "Command: `gh pr diff 490 --repo OmniAgent/evaluation`",
    );
