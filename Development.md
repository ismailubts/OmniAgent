...
This guide is for people working on OmniAgent and editing the source code.
If you wish to contribute your changes, check out the
[CONTRIBUTING.md](https://github.com/ismailubts/OmniAgent/blob/main/CONTRIBUTING.md)
on how to clone and setup the project initially before moving on. Otherwise,
you can clone the OmniAgent project directly.
...
OmniAgent supports a diverse array of Language Models (LMs) through the powerful [litellm](https://docs.litellm.ai) library.

For the V1 web app, start OmniAgent and configure your model and API key in the Settings UI.
...
See [our documentation](https://github.com/ismailubts/OmniAgent/blob/main/usage/llms/llms) for recommended models.
...
These targets serve the current OmniAgent V1 API by default. In the codebase, `make start-backend` runs `omniagent.server.listen:app`, and that app includes the `omniagent/app_server` V1 routes unless `ENABLE_V1=0`.
...
If you just want to run OmniAgent without setting up a dev environment:
...
## Running OmniAgent with OmniAgent

You can use OmniAgent to develop and improve OmniAgent itself!
...
- [/Development.md](./Development.md) (this file): Comprehensive guide for developers working on OmniAgent
- [/CONTRIBUTING.md](./CONTRIBUTING.md): Guidelines for contributing to the project, including code style and PR process
- [DOC_STYLE_GUIDE.md](https://github.com/OmniAgent/docs/blob/main/omniagent/DOC_STYLE_GUIDE.md): Standards for writing and maintaining project documentation
- [/omniagent/app_server/README.md](./omniagent/app_server/README.md): Current V1 application server implementation and REST API modules
- [/frontend/README.md](./frontend/README.md): Frontend React application setup and development guide
- [/containers/README.md](./containers/README.md): Information about Docker containers and deployment
- [/tests/unit/README.md](./tests/unit/README.md): Guide to writing and running unit tests
- [OmniAgent/benchmarks](https://github.com/OmniAgent/benchmarks): Documentation for the evaluation framework and benchmarks
