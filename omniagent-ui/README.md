...
```bash
# npm
npm install @omniagent/ui

# yarn
yarn add @omniagent/ui

# pnpm
pnpm add @omniagent/ui

# bun
bun add @omniagent/ui
```

## Quick Start

```tsx
import { Button, Typography } from "@omniagent/ui";
import "@omniagent/ui/styles";
...
# Replace `path/to/omniagent-ui-x.x.x.tgz` with the actual path to the generated `.tgz` file.
npm install path/to/omniagent-ui-x.x.x.tgz
```
