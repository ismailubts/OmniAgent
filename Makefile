...
# Makefile for OmniAgent project
...
start-backend:
	...
	@poetry run uvicorn omniagent.server.listen:app --host $(BACKEND_HOST) --port $(BACKEND_PORT) --reload --reload-exclude "./workspace"
...
_run_setup:
	...
	@poetry run uvicorn omniagent.server.listen:app --host $(BACKEND_HOST) --port $(BACKEND_PORT) &
...
help:
	...
	@echo "  $(GREEN)setup-config$(RESET)        - Setup the configuration for OmniAgent by providing LLM API key,"
	@echo "                        LLM Model name, and workspace directory."
	@echo "  $(GREEN)start-backend$(RESET)       - Start the backend server for the OmniAgent project."
	@echo "  $(GREEN)start-frontend$(RESET)      - Start the frontend server for the OmniAgent project."
	@echo "  $(GREEN)run$(RESET)                 - Run the OmniAgent application, starting both backend and frontend servers."
	@echo "                        Backend Log file will be stored in the 'logs' directory."
	@echo "  $(GREEN)docker-dev$(RESET)          - Build and run the OmniAgent application in Docker."
	@echo "  $(GREEN)docker-run$(RESET)          - Run the OmniAgent application, starting both backend and frontend servers in Docker."
